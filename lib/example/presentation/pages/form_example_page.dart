...
import 'package:shopzy/example/domain/notifiers/form_example_state_notifier/form_example_state_notifier.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        tooltip: 'Increment',
        child:
            ref.watch(isNextEnabled) ? Icon(Icons.add) : Icon(Icons.abc_sharp),
      ),
    );
  }
